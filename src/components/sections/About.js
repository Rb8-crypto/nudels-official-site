  ...
  return (
    <Section id="about">
      <Container>
        ...
        <Box> 
        <Title>
        Welcome To The <br /> Nudels Club.
        </Title>
        <SubText>
        The NUDELS Collection is a collection of 8,888 NFTs—unique generated digital collectibles. Nudels are stored and minted as ERC-721 tokens on the Ethereum blockchain.
        </SubText>
        <SubTextLight>
        ...
        <Button text="FOLLOW US" link="https://twitter.com/nudelsnft" />
        </ThemeProvider>
        </ButtonContainer>
         </Box>
      </Container>
